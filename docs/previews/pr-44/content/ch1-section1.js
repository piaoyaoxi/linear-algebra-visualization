defineChapter1Section("number-fields", {
  ...
  title: "数域：先规定允许的运算",
  navTitle: "数域",
  question: "一个集合怎样才能作为多项式的系数域？扩大系数域后，同一个多项式会得到哪些新的因式？",
  ...
  interactive: {
    type: "slot",
    title: "实验：系数域与分解",
    description: "先检查候选集合能否承受四则运算，再沿着系数域包含链追踪同一个多项式。",
    task: "怎样判断一个集合能否作为系数域？系数域扩大时，哪些系数和因式会进入视野？",
    controlsTitle: "选择候选集合",
    controlsDescription: "切换集合，查看它通过了哪些封闭性条件，并读取一个足以完成判断的证据。",
    guide: [
      ["检查封闭性", "依次查看零与单位、加法逆元、乘法和非零求逆。"],
      ["检查系数", "先确认多项式属于当前的 F[x]。"],
      ["比较分解", "沿着 Q、Q(√2)、R、C 观察新因式何时出现。"],
    ],
    takeaway: "数域规定可用的系数和运算；根与不可约性都依赖所选的系数域。",
    prompts: [
      "在整数集中找到非零除法失败的反例。",
      "展开 Q(√2) 的乘法与求逆公式。",
