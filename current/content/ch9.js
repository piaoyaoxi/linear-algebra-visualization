  ...
  const sections = [
    {
      ...
      summary: [
        ...
        "对非零向量，内积的正、零、负分别对应锐角、直角与钝角；下一节把这些几何量放进标准正交坐标。",
      ],
      textbook: {
    ...
    },
    {
      ...
      summary: [
        ...
        "线性无关保证余量非零，矩阵形式就是 A=QR；下一节据此比较一般线性同构与保持内积的欧氏同构。",
      ],
      textbook: {
    ...
    },
    {
      ...
      summary: [
        ...
        "斜基坐标中的几何由 Gram 矩阵 G=BᵀB 记录；下一节专门研究保持这套几何的正交变换。",
      ],
      textbook: {
    ...
    },
    {
      ...
      summary: [
        ...
        "二维中 det=1 对应旋转，det=-1 对应反射；下一节把正交性用于子空间分解与最近点投影。",
      ],
      textbook: {
    ...
    },
    {
      ...
      summary: [
        ...
        "最近点定理是正交分解与勾股恒等式的直接结果；下一节把正交补不变用于证明实谱定理。",
      ],
      textbook: {
    ...
    },
    {
      ...
      summary: [
        ...
        "A=QΛQᵀ 同时给出标准正交特征基、主轴动作和谱投影分解；下一节把投影观点用于不相容方程的最小二乘解。",
      ],
      textbook: {
    ...
    },
    {
      ...
      summary: [
        ...
        "预测向量总唯一，系数的唯一性取决于 A 的列是否线性无关；下一节把转置、正交与谱定理推广到复酉空间。",
      ],
      textbook: {
