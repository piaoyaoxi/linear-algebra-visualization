    ...
    sections: [
      ...
      },
      {
        ...
        interactive: {
          ...
          task:
            "比较正交特征基、斜特征基与 Jordan 块；拖动 x 和过程滑杆，说明任意特征向量基都能完成对角化，并找出缺少一个特征方向时流程停止的位置。",
          prompts: [
        ...
        summary: [
          ...
          "下一节回到一般线性变换，用像与核量化输出方向和被完全抹去的输入方向，为后续不变子空间作准备。",
        ],
      },
      {
        id: "image-and-kernel",
      ...
      },
      {
        ...
        interactive: {
          ...
          prompts: [
            ...
            "确认一个高次候选可以湮灭算子，再找出更低次的首一湮灭多项式以排除它的最小性。",
          ],
        },
        textbook: sources(
