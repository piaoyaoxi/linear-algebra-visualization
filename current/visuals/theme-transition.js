(() => {
  ...
  const DARK = {
    "--bg": [12, 17, 14, 1],
    "--bg-grid": [181, 198, 186, 0.026],
    "--surface": [178, 196, 184, 0.065],
    "--surface-solid": [24, 31, 27, 0.95],
    "--surface-soft": [141, 165, 149, 0.075],
    "--text": [237, 241, 236, 1],
    "--muted": [171, 181, 173, 1],
    "--faint": [120, 131, 123, 1],
    "--line": [220, 232, 223, 0.095],
    "--line-strong": [220, 232, 223, 0.17],
    "--accent": [120, 146, 127, 1],
    "--accent-strong": [191, 208, 194, 1],
    "--accent-soft": [120, 146, 127, 0.14],
    "--canvas-paper-top": [24, 32, 27, 1],
    "--canvas-paper-bottom": [18, 24, 19, 1],
    "--canvas-paper-glow": [120, 146, 127, 0.055],
